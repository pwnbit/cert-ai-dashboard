# CERT AI Agent Virtual Office Simulator (v2.1)
...
> [!NOTE]
> **v2.1 업데이트 사항**: 관제 터미널 로그, 말풍선 대화, 슬랙 경보 카드 등의 전면 **한글화**가 완료되었으며, 4K 고해상도 모니터용 반응형 배치 최적화 및 Tier 2 에스컬레이션 피드백 액션 빔 경로 버그가 패치되었습니다.
...
5. **TI Expert Agent (Threat Intelligence) 🔍**
   - 외부 블랙리스트 DB 및 위협 인텔리전스 조회 결과를 분석가에게 피드백합니다.
